      ...
      <div className="lg:col-span-3 space-y-6 sm:space-y-8">
        <div className="space-y-3 sm:space-y-2">
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-medium tracking-tight">
            Akhil <span className="text-muted-foreground">Parmar</span>
          </h1>
        </div>
        ...
        <div className="space-y-6 max-w-md">
          ...
          <div className="flex flex-row sm:items-center gap-3 sm:gap-4 text-sm text-muted-foreground">
            <div className="flex items-center gap-2">
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Link href={"mailto:akhil1659@gmail.com"}>
          ...
          <div className="flex flex-wrap gap-3 pt-4">
            <Tooltip>
              <TooltipTrigger asChild>
                <Link
                  href="https://drive.google.com/file/d/1un429I3v5R8vyqzORiKT_vVOmyhLFFbW/view?usp=sharing"
                  target="_blank"
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap gap-2">
            {[
              ...
              <span
                key={service}
                className="px-3 cursor-pointer py-1 text-xs bg-accent/45 backdrop-blur-lg border border-dashed border-border rounded-lg hover:border-muted-foreground/50 transition-colors duration-300"
              >
                {service}
              </span>
            ))}
